...
const DetailedLearningPage: React.FC = () => {
      ...
      words: [
        {
          ...
          example: '회사에서 상사에게 인사할 때 사용하는 정중한 표현입니다. 아침 10시까지 사용합니다.'
        },
        {
          japanese: 'こんにちは',
          pronunciation: '콘니치와',
          meaning: '안녕하세요 (낮 인사)',
          example: '오전 11시부터 오후 5시까지 사용하는 인사말입니다.'
        },
        {
          japanese: 'こんばんは',
          pronunciation: '콘반와',
          meaning: '안녕하세요 (저녁 인사)',
          example: '저녁 시간대에 만나는 사람에게 하는 인사말입니다.'
        }
      ],
      conversations: [
        {
        ...
        {
          situation: '상점에서 점원과 인사',
          japanese: 'こんにちは。いらっしゃいませ。',
          pronunciation: '콘니치와。이라샤이마세。',
          korean: '안녕하세요. 어서 오세요.'
        },
        {
          situation: '이웃과 저녁에 마주칠 때',
          japanese: 'こんばんは。お疲れ様でした。',
          pronunciation: '콘반와。오츠카레사마데시타。',
          korean: '안녕하세요. 수고하셨습니다.'
        }
      ],
      culture: {
        title: '일본의 인사 문화와 예의',
        content: '일본에서는 인사할 때 반드시 목례를 하는 것이 중요합니다. 특히 직장에서는 상하 관계에 따라 인사말의 정중함이 달라집니다. 또한 시간대별로 다른 인사말을 사용하는 것이 일본 문화의 특징입니다. 아침에는 おはようございます, 낮에는 こんにちは, 저녁에는 こんばんは를 사용합니다.'
      },
      dialects: [
        {
          region: '오사카',
        ...
        },
        {
          ...
          dialect: 'おはようさんどす',
          standard: 'おはようございます',
          meaning: '좋은 아침입니다 (교토식)'
        },
        {
          region: '히로시마',
          dialect: 'おはようさんじゃ',
          standard: 'おはようございます',
          meaning: '좋은 아침입니다 (히로시마식)'
        }
      ]
    }
...
export default DetailedLearningPage
